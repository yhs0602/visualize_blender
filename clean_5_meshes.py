...
def clean_mesh(path: str):
    ...
    o3d.io.write_triangle_mesh(f"cleaned_5_meshes/{out_ply_name}", mesh_0)
...
if __name__ == "__main__":
    ...
    for file in os.listdir(dir_name):
        print(file)
        algorithm, obj = file.split(".")[0].split("_")
        # obj = file.split(".")[0]
        print(f"{algorithm=}{obj=}")
        if file.endswith(".ply") and algorithm == "ours" and obj == "ficus":
